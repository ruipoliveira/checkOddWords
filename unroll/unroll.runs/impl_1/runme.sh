...
HD_PWD='D:/ECT-UA/CR/tarefa19_1/unroll/unroll.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log unroll.vdi -applog -m64 -messageDb vivado.pb -mode batch -source unroll.tcl -notrace

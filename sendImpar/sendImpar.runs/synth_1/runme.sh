...
HD_PWD='D:/ECT-UA/CR/tarefa19_1/sendImpar/sendImpar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sendImpar.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sendImpar.tcl

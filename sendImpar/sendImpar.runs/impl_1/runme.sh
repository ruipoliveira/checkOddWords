...
HD_PWD='D:/ECT-UA/CR/tarefa19_1/sendImpar/sendImpar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sendImpar.vdi -applog -m64 -messageDb vivado.pb -mode batch -source sendImpar.tcl -notrace

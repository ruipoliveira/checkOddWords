...
HD_PWD='D:/ECT-UA/CR/tarefa19_1/imparE/imparE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log imparE.vdi -applog -m64 -messageDb vivado.pb -mode batch -source imparE.tcl -notrace

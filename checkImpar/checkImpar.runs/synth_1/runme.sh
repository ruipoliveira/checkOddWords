...
HD_PWD='D:/ECT-UA/CR/tarefa19_1/checkImpar/checkImpar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log checkImpar.vds -m64 -mode batch -messageDb vivado.pb -notrace -source checkImpar.tcl

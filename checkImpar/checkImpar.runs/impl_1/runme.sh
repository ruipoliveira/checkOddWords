...
HD_PWD='D:/ECT-UA/CR/tarefa19_1/checkImpar/checkImpar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log checkImpar.vdi -applog -m64 -messageDb vivado.pb -mode batch -source checkImpar.tcl -notrace

...
HD_PWD='D:/ECT-UA/CR/tarefa19_1/hardwareVersion/hardwareVersion.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hardversion_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hardversion_wrapper.tcl

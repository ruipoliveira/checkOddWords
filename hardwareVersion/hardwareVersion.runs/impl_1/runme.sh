...
HD_PWD='D:/ECT-UA/CR/tarefa19_1/hardwareVersion/hardwareVersion.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hardversion_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source hardversion_wrapper.tcl -notrace

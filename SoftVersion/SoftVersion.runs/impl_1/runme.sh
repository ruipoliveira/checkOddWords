...
HD_PWD='D:/ECT-UA/CR/tarefa19_1/SoftVersion/SoftVersion.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_version_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source MB_version_wrapper.tcl -notrace

...
HD_PWD='D:/ECT-UA/CR/tarefa19_1/SoftVersion/SoftVersion.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_version_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source MB_version_wrapper.tcl

...
#
# Generated by export_simulation on Fri Jun 03 03:42:54 +0100 2016
#
################################################################################
...
switch to the './MB_version.sh' script.

./MB_version.sh -reset_run
...
./MB_version.sh -noclean_files

For more information on the script, please type './MB_version.sh -help'.
